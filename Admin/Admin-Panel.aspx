        ...
        <tr>
            ...
            <td style="padding:50px,50px,50px,50px;">
                <asp:DropDownList ID="DDLBCat" runat="server">
                    <asp:ListItem>Genomics</asp:ListItem>
                    <asp:ListItem>Proteomics</asp:ListItem>
                    <asp:ListItem>Metagenomics</asp:ListItem>
                    <asp:ListItem>Structural Bioinformatics</asp:ListItem>
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td>Blog Title</td>
